...
const dataItems = [
    {title:"Go to gim", aragraph: "20 push nps,10 pnll ups, 12 minutes cardio"},
    {title:"Go to gim", aragraph: "do Math, cry, do music practice, cry"},
    {title:"Go to gim", aragraph: "get 5 kb from your teacher"},
    {title:"Go to gim", aragraph: "Wellcom to the club body"},
    {title:"Go to gim", aragraph: "Go to the school"},
]
